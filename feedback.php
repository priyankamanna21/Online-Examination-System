...
<div class="col-md-10">
<a href="mailto:chiraggoel.53784@gmail.com" style="color:#000000">mannapriyanka097@gmail.com</a><br /><br />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<p style="color:#202020; font-family:'typo' ; font-size:18px">Dipanita Mallick</p>
        <p style="color:#202020; font-family:'typo' ; font-size:18px">Priyanka Manna</p>
            <p style="color:#202020; font-family:'typo' ; font-size:18px">Saikat Ghosh</p>
                <p style="color:#202020; font-family:'typo' ; font-size:18px">Sudip kumar Santra</p>
                    <p style="color:#202020; font-family:'typo' ; font-size:18px">Aman Kumar</p>
                        <p style="color:#202020; font-family:'typo' ; font-size:18px">Garbita Ghosh</p>

    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 9547521610</h4>
  
    <h4 style="font-family:'typo' ">Dr B C Roy Engineering College ,Durgapur</h4></div></div>
    </p>
      </div>
